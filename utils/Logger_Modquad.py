...
class Logger(object):
    ...
    def __init__(self,
        ...
        self.states = np.zeros((num_drones, 20, duration_sec*self.LOGGING_FREQ_HZ)) #### 12+2*4 states:
                                                                                                          # pos_x,
                                                                                                          # pos_y,
                                                                                                          # pos_z,
                                                                                                          # vel_x,
    ...
    def log(self,
        ...
        #                                                  xyz          v             rpy          w             rpms
        self.states[drone, :, current_counter] = np.hstack([state[0:3], state[10:13], state[7:10], state[13:16], state[16:]])
    ...
    def plot_rpms(self):
        ...
        col = 1
        row = 0
        axs[row, col].plot(t, self.states[0, 16, :], label="drone_" + str(0))
        axs[row, col].set_xlabel('time')
        axs[row, col].set_ylabel('RPM4')
        row = 1
        axs[row, col].plot(t, self.states[0, 17, :], label="drone_" + str(0))
        axs[row, col].set_xlabel('time')
        axs[row, col].set_ylabel('RPM5')
        row = 2
        axs[row, col].plot(t, self.states[0, 18, :], label="drone_" + str(0))
        axs[row, col].set_xlabel('time')
        axs[row, col].set_ylabel('RPM6')
        row = 3
        axs[row, col].plot(t, self.states[0, 19, :], label="drone_" + str(0))
        axs[row, col].set_xlabel('time')
        axs[row, col].set_ylabel('RPM7')
