...
class ProgressionBaseAviary(gym.Env):
    ...
    def __init__(self,
        ...
        # if drone_model==DroneModel.TBO:
        #     self.num_rotors = 8
        #     self.num_modules = 2
        # elif drone_model==DroneModel.TBT:
        #     self.num_rotors = 16
        #     self.num_modules = 4
        # elif drone_model==DroneModel.PLUS:
        #     self.num_rotors = 20
        #     self.num_modules = 5
        # elif drone_model==DroneModel.FBF:
        #     self.num_rotors = 64
        #     self.num_modules = 16
    ...
    def step(self,
        ...
        if self.USE_GUI_RPM:
            for i in range(self.num_rotors):        # modified by rui
    ...
    def _housekeeping(self):
        ...
        self.gui_input = np.zeros(self.num_rotors)
        ...
        self.DRONE_IDS = np.array([p.loadURDF('/home/ruirui/gym-pybullet-drones/gym_pybullet_drones/assets/'+self.DRONE_MODEL.value[0]+'/'+self.URDF,
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):     # modified by rui, swap entire function
